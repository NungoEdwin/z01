// Neo4j Cypher Script to Initialize Sample Data
// Run this in Neo4j Browser after starting the application
...
// Verify data
MATCH (m:Movie) RETURN m.title, m.genres, m.releaseDate ORDER BY m.releaseDate DESC;
